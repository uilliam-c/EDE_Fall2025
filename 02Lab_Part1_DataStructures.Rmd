...
# Returns the max value for this vector
max(vector1)
...
# Multiplies 1st value by 4th value
vector1 * vector4
...
vector1[1]-mean(vector1)
vector1[2]-mean(vector1)
vector1[3]-mean(vector1)
vector1[4]-mean(vector1)
vector1[5]-mean(vector1)
...
matrix1[4, 1] # value in row 4 column 1

matrix1[4,  ] #

matrix1[ , 3] #

matrix1[c(12, 14)] # vector with two items, 12th and 14th items

matrix1[c(12:14)] # start and end slice of values from the matrix

matrix1[2:4, 1:3] # sub slices of values, second to fourth row and first to third column
...
f <- c(TRUE, TRUE, TRUE, FALSE) # What type of vector? Boulian
